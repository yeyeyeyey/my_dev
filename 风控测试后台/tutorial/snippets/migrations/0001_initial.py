# Generated by Django 2.2.5 on 2019-11-14 10:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testEnv', models.CharField(blank=True, default='', max_length=100)),
                ('decisionName', models.CharField(blank=True, default='', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('title', models.CharField(blank=True, default='', max_length=100)),
                ('createWay', models.CharField(blank=True, default='', max_length=100)),
                ('cid', models.CharField(blank=True, default='', max_length=100)),
                ('sqs', models.CharField(blank=True, default='', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('creditName', models.CharField(blank=True, default='', max_length=100)),
                ...
                ('isDelete', models.BooleanField(default=False)),
                ('paramType', models.CharField(blank=True, default='', max_length=100)),
                ('testEnv', models.CharField(blank=True, default='', max_length=100)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('strategy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='strategyfiled', to='snippets.Strategy')),
            ],
            options={
                'ordering': ('created',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('strategyName', models.CharField(blank=True, default='', max_length=100)),
                ('strategyAlias', models.CharField(blank=True, default='', max_length=100)),
                ('paramType', models.CharField(blank=True, default='', max_length=100)),
                ('interface', models.CharField(blank=True, default='', max_length=100)),
                ('currentValueType', models.CharField(blank=True, default='', max_length=100)),
                ('currentValue', models.CharField(blank=True, default='', max_length=100)),
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('field', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='filed', to='snippets.StrategyFiled')),
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reportfileds', to='snippets.ReportHistory')),
            ],
            options={
                'ordering': ('created',),
            },
